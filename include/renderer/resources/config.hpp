...
namespace renderer {
    ...
    enum class ImageViewType : std::uint32_t {
        IMAGE_1D,
        IMAGE_2D,
        IMAGE_3D,
    };
    ...
    enum class PolygonFaceWinding : std::uint32_t {
        CLOCKWISE,
        ANTICLOCKWISE,
    };

    // @brief Defines the culling mode of a polygon
    enum class PolygonCullMode : std::uint32_t {
        NEVER,
        FRONT,
        BACK,
        ALWAYS,
    ...
    enum class ValueOperation : std::uint32_t {
        KEEP,
        ZERO,
        REPLACE,
        INCREMENT_AND_CLAMP,
    ...
    enum class PolygonTopology : std::uint32_t {
        POINT,
        LINE,
        TRIANGLE,
        LINE_STRIP,
    ...
    enum class VertexAttributeFormat : std::uint32_t {
        R32_FLOAT,
        R32G32_FLOAT,
        R32G32B32_FLOAT,
        R32G32B32A32_FLOAT,
