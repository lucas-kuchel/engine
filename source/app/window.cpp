...
namespace app {
    ...
    public:
        Implementation(const WindowCreateInfo& createInfo)
            ...
            if (!handle_) {
                throw std::runtime_error("Error calling app::Window::Implementation::Window::Implementation(): Failed to create window");
            }
        ...
        void* getNativeHandle() {
            ...
            throw std::runtime_error("Error calling app::Window::Implementation::getNativeHandle(): Cannot query backend when not under Cocoa or Win32");

#endif

            throw std::runtime_error("Error calling app::Window::Implementation::getNativeHandle(): Backend is unsupported");
        }
    ...
    private:
        ...
        static void resizeCallback(GLFWwindow* window, int width, int height) {
            auto self = static_cast<Window::Implementation*>(glfwGetWindowUserPointer(window));
    ...
    void Window::create(const WindowCreateInfo& createInfo) {
        ...
        implementation_ = std::make_unique<Implementation>(createInfo);
    }
